    ...
    <div className="modules">
      <div className="outline1">
        ...
        <div className="cardcontent">
          {" "}
          Users tackle diverse questions about banking by through a card game
          board to reveal scenarios. These must be sorted into relevant
          categories. Each level brings new challenges, and completing them
          rewards users with coins. Dive into "Card Flip" and help yourself
          become <span>#BankSmart</span>.
        </div>
        <div className="out1">
          <img className="lo1" src={logoPurple} />
          <div className="button1">Lets Play!</div>
        </div>
      </div>
      ...
      <div className="outline3">
        ...
        <div className="cardcontent">
          {" "}
          Master your finances with our 50-30-20 budgeting tool. Simply enter
          your monthly income, and we'll automatically divide it into 50% for
          needs, 30% for expenses, and 20% for savings, tailored to each user's
          monthly budget.Take control of your financial future with our
          user-friendly platform, designed to make budgeting simple and
          effective.<span>#SpendSmart</span>
        </div>
        <div className="out2">
          <img src={logoOrange} />
          <div className="button">Lets Save!</div>
        </div>
      </div>
